...
<body>
	<div class="usuario-form">
		...
		<div class="form-group">
			...
			<div class="form-group">
				<div class="input-group">
					<label class="control-label" for="materia">Materia:</label><input type="text" class="form-control" id="materia" required="required" maxlength="100">
				</div>
			</div>
			<div class="form-group">
				<button type="button" id="submitButton" onclick="submitCrearDocente();" class="btn btn-success login-btn btn-block" >Registrar</button>
			</div>
			<label id="registrarDocente-errorLabel" style="display: none;" class="alert alert-danger"></label>
			<div class="form-group">
            ...
            success : function (response) {
                if (response.result !== null && response.result !== undefined) {
                    if (response.result) {
                        ...
                        $('#registrarDocente-errorLabel').text(response.message);
                        $('#registrarDocente-errorLabel').show();
                        setTimeout(function () {
                            $('#registrarDocente-errorLabel').hide();
                        }, 5000);
                    }
                }
            }
